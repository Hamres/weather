...
export const handleWeatherByGeolocation = () => {
  ...
  const success = async (pos) => {
    ...
    const response = await fetch(`https://api.geoapify.com/v1/geocode/reverse?lat=${crd.latitude}&lon=${crd.longitude}&lang=ru&apiKey=0fddb33853184e72963a9bf9f937f2fe`)
